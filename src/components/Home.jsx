...
const Home = () => {
  return (
    <div name="home" className="w-full h-screen pt-20 bg-gradient-to-b from-black to-gray-800 via-black">
      <div className="flex flex-col items-center justify-center h-full max-w-screen-lg px-4 pt-12 mx-auto md:flex-row">
        <div className="flex flex-col justify-center h-full pt-12">
          <h2 className="pt-12 text-4xl font-bold text-white sm:text-7xl">I'm a Full Stack Developer</h2>
          <br />
